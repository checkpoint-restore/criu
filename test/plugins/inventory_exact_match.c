...
static int inventory_exact_match_init(int stage)
{
...
static void inventory_exact_match_fini(int stage, int ret)
{
}

CR_PLUGIN_REGISTER("inventory_exact", inventory_exact_match_init,
		   inventory_exact_match_fini)
