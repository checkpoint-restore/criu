...
ifeq ($(filter tags etags cscope clean lint indent .clang-format help mrproper,$(MAKECMDGOALS)),)
...
indent:
	clang-format -i criu/{uts_ns,lsm,cr-errno,string,sigframe,external,cr-dedup,file-ids}.c
	clang-format -i criu/unittest/*.c
.PHONY: indent
