...
struct mount_info {
	...
	struct list_head unmounted_mnt_list;
...
extern struct mount_info *mount_info_for_unmounted_mount(int lfd);
...
extern struct mount_info *is_unmounted_mnt(int mnt_id);
extern int remove_unmounted_mountpoints(void);

extern struct mount_info *root_yard_mp;
extern char *mnt_roots;
extern struct list_head unmounted_mounts;
