...
usage:
	...
	pr_msg("\n"
	       ...
	       "  --lazy-pages-threads N\n"
	       "                        number of worker threads used to drain lazy pages\n"
	       "                        in the background (default: min(cpus, 16), 0 or 1\n"
	       "                        forces the serial drain). The drain is memory\n"
	       "                        bandwidth bound, so set N to the number of physical\n"
	       "                        cores; hyperthread siblings share bandwidth and add\n"
	       "                        CPU cost without speeding up the drain\n"
