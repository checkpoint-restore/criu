...
int kerndat_init(void)
{
	...
	/*
	 * When our process is running in secure mode (e.g., with
	 * setuid/setcap CRIU binary), our process becomes non-dumpable, which
	 * makes our /proc/self root owned, preventing some of the kerndat
