...
void cr_pb_init(void)
{
	...
	CR_PB_DESC(MEMFD_SECRET_FILE, MemfdSecretFile, memfd_secret_file);
	CR_PB_DESC(MEMFD_SECRET_INODE, MemfdSecretInode, memfd_secret_inode);
